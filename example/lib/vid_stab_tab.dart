...
class VidStabTab {
  ...
  void setActive() {
    ...
    showTooltip(VIDSTAB_TEST_TOOLTIP_TEXT);
  }
...
var vidStabColumn = Column(
  ...
  children: <Widget>[
    Container(
        ...
        child: Container(
          ...
          child: DropdownButtonHideUnderline(
            ...
            value: vidStabTab._currentCodec,
            items: vidStabTab._codecDropDownMenuItems,
            onChanged: vidStabTab._changedCodec,
            iconSize: 0,
            isExpanded: false,
          )),
        )),
    Container(
      ...
      child: new InkWell(
        onTap: () => vidStabTab.testEncodeVideo(),
        child: new Container(
          width: 100,
          height: 38,
    ...
    Expanded(
      child: Container(
          ...
          child: SingleChildScrollView(
              reverse: true, child: Text(vidStabTab._commandOutput))),
    )
  ],
);
