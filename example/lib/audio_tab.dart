...
class AudioTab {
  ...
  void setActive() {
    ...
    showTooltip(AUDIO_TEST_TOOLTIP_TEXT);
  }
...
var audioColumn = Column(
  ...
  children: <Widget>[
    Container(
        ...
        child: Container(
          ...
          child: DropdownButtonHideUnderline(
            ...
            value: audioTab._currentCodec,
            items: audioTab._codecDropDownMenuItems,
            onChanged: audioTab._changedCodec,
            iconSize: 0,
            isExpanded: false,
          )),
        )),
    Container(
      ...
      child: new InkWell(
        onTap: () => audioTab.testEncodeVideo(),
        child: new Container(
          width: 100,
          height: 38,
    ...
    Expanded(
      child: Container(
          ...
          child: SingleChildScrollView(
              reverse: true, child: Text(audioTab._commandOutput))),
    )
  ],
);
