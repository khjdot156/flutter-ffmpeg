...
class SubtitleTab {
  ...
  void setActive() {
    ...
    showTooltip(SUBTITLE_TEST_TOOLTIP_TEXT);
  }
...
var subtitleColumn = Column(
  ...
  children: <Widget>[
    Container(
        ...
        child: Container(
          ...
          child: DropdownButtonHideUnderline(
            ...
            value: subtitleTab._currentCodec,
            items: subtitleTab._codecDropDownMenuItems,
            onChanged: subtitleTab._changedCodec,
            iconSize: 0,
            isExpanded: false,
          )),
        )),
    Container(
      ...
      child: new InkWell(
        onTap: () => subtitleTab.testEncodeVideo(),
        child: new Container(
          width: 100,
          height: 38,
    ...
    Expanded(
      child: Container(
          ...
          child: SingleChildScrollView(
              reverse: true, child: Text(subtitleTab._commandOutput))),
    )
  ],
);
