...
class PipeTab {
  ...
  void setActive() {
    ...
    showTooltip(PIPE_TEST_TOOLTIP_TEXT);
  }
    ...
    Container(
        ...
        child: Container(
          ...
          child: DropdownButtonHideUnderline(
            ...
            value: pipeTab._currentCodec,
            items: pipeTab._codecDropDownMenuItems,
            onChanged: pipeTab._changedCodec,
            iconSize: 0,
            isExpanded: false,
          )),
        )),
    ...
    Expanded(
      child: Container(
          ...
          child: SingleChildScrollView(
              reverse: true, child: Text(pipeTab._commandOutput))),
    )
  ],
);
